...
class TriggerScopeController(ImConWidgetController):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._widget.sigSaveScan.connect(self.saveScan)
        self._widget.sigLoadScan.connect(self.loadScan)
        self._widget.positionEdit.valueChanged.connect(self.changePosition)
    ...
    def plotSignalGraph(self):
        ...
        dwellTime = float(self._widget.dwellTimePar.text())
        graphSamples = 10000
